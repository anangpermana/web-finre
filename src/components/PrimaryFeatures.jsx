...
import capture2 from '@/images/logos/capture2.png'
import capture3 from '@/images/logos/capture3.png'
import capture4 from '@/images/logos/capture4.png'
    ...
    >
      ...
      <div className="relative col-span-6">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
          <CircleBackground color="#6553A4" className="animate-spin-slower" />
        </div>
      ...
      <Container>
        <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-3xl">
          <h2 className="text-3xl font-medium tracking-tight text-white">
            Fitur yang anda butuhkan sudah kami sediakan.
          </h2>
          <p className="mt-2 text-lg text-gray-400">
            Finre sudah menyediakan fitur fitur untuk memudahkan anda dalam mencacat pemasukan dan pengeluaran, disertai dengan detail setiap transaksi yang anda lakukan.
          </p>
        </div>
      </Container>
