...
import capture from '@/images/logos/capture1.png'
    ...
    <div {...props}>
      ...
      >
        ...
        <defs>
          ...
          >
            <stop stopColor="#340169" />
            <stop offset="1" stopColor="#340169" stopOpacity="0" />
          </linearGradient>
        </defs>
      </svg>
      <svg
  ...
  return (
    ...
    >
      ...
      <motion.path
        ...
        {...(isInView ? { stroke: '#340169', animate: { pathLength: 1 } } : {})}
        onUpdate={({ pathLength }) => {
          pathWidth.set(
      ...
      <Container>
        <div className="lg:grid lg:grid-cols-12 lg:gap-x-8 lg:gap-y-20">
          <div className="relative z-10 mx-auto max-w-2xl lg:col-span-7 lg:max-w-none lg:pt-6 xl:col-span-6">
            ...
            Catat Data Financial Anda.
            </h1>
            <p className="mt-6 text-lg text-gray-600">
              Dengan mencatat data pemasukan dan pengeluaran keuangan, Anda bisa mengetahui categori mana saja uang digunakan. Dengan begitu kita bisa lebih bijak dalam membelanjakan uang.
            </p>
